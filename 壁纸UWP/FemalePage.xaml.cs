...
namespace 壁纸UWP
{
    ...
    /// </summary>
    public sealed partial class FemalePage : Page
    {
        public FemalePage()
        {
        ...
        public void Show(int Start)
        {
            ...
            string uri_id = "http://wallpaper.apc.360.cn/index.php?c=WallPaper&a=getAppsByCategory&cid=6&start=" + Start.ToString() + "&count=15&from=360chrome";
