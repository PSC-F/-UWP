...
namespace 壁纸UWP
{
    ...
    public sealed partial class ViewPage : Page
    {
        ...
        public void Show(int Start)
        {
            ...
            string uri_id = "http://wallpaper.apc.360.cn/index.php?c=WallPaper&a=getAppsByCategory&cid=9&start=" + Start.ToString() + "&count=15&from=360chrome";
        ...
        private void IndexListView1_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (IndexListView1.SelectedIndex != -1)
            {
                ...
                NotifyPopup notifyPopup = new NotifyPopup("保存成功,在图库查看");
                notifyPopup.Show();
            }
        }
        ...
        private void IndexListView2_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (IndexListView2.SelectedIndex != -1)
            {
                ...
                NotifyPopup notifyPopup = new NotifyPopup("保存成功在图库查看");
                notifyPopup.Show();
            }
        }
